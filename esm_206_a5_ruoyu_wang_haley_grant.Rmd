...
>>>>>>> 801e42f3c65d698fff882c7425a6bc4ca9b67196
...
<<<<<<< HEAD
# Find the counts of salamander by channel classification (pool, cascades and side-channel) in old growth (OG) and clear cut (CC) sections of Mack Creek in year 2017.
>>>>>>> b3bb270534419ef70e6ec4dcd7f661ceaf18a97b
=======
...
Null Hypothesis (H0): The mean weights of Pacific giant salamanders from Pool, Cascade, and Side Channel are the same. Alternative Hypothesis (HA): At least two group means are NOT equal.
...
c) Population variances are equal. In the summary table, notice that the largest variance (Pool - `r round(channel_summary_table$var[2], 2)`) is less than the four times of the smallest variance (Side Channel - `r round(channel_summary_table$var[3], 2)`), which means the variances are close enough. Besides, through the levene_test
